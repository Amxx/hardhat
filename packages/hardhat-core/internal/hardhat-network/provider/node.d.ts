...
export declare class HardhatNode extends EventEmitter {
    ...
    private _parentBeaconBlockRootGenerator;
    ...
    getTransactionReceipt(hash: Uint8Array | string): Promise<RpcReceiptOutput | undefined>;
    ...
    private _getNextParentBeaconBlockRoot;
    private _getEstimateGasFeePriceFields;
    private _selectHardfork;
    private _getCommonForTracing;
}
export declare function assertTransientStorageCompatibility(enableTransientStorage: boolean, hardfork: HardforkName): void;
